...
expectedKeys = IntMap.fromList
  [ ( 0
    , Key
      (KeyPair
        (PublicKey "d40aada7036bfe72e7ff0aaa16e1f4446b7dea9f26a6c0d0824cd69c42dc1118")
  ...
  , ( 1
    , Key
      (KeyPair
        (PublicKey "4e6756f17642c430795e2780d7a1193449ece6e5d9b0ab8d9c01d6a3b8a4d1a1")
  ...
  , ( 3
    , Key
      (KeyPair
        (PublicKey "c9bf2214b6c134fe387798c4994f44606b61ed05c98191c0e00ab79e75b54c2e")
  ...
  , ( 4
    , Key
      (KeyPair
        (PublicKey "b7d6d1e3f20df081b5bbd3159406d9593ac2973e3297cfc13b962513bd537630")
  ...
  , ( 5
    , Key
      (KeyPair
        (PublicKey "b92a5ffed43abe09d3679a6c1ce084a87916dfc3bbb0e1cb10d2b5c5152117fd")
  ...
  , ( 6
    , Key
      (KeyPair
        (PublicKey "c5535652d34724d3489d82a1b9217617eaa1ba607b8c123ecd4b393ea5ee293f")
  ...
  , ( 7
    , Key
      (KeyPair
        (PublicKey "496df4caddbb907e8ff1c76e4979a176ab1b12bd30e7d3136a8e566b50e07b52")
  ...
  , ( 8
    , Key
      (KeyPair
        (PublicKey "c7fb88b67dee06b1f610411e48da6b87328fa4aea80c533a0ca96f64d3eb0632")
    ...
    , Accounts
      (Map.fromList
        [ ( AccountName "benkolera"
          , Map.fromList
            [ ("0" , VanityAccount (PublicKey "496df4caddbb907e8ff1c76e4979a176ab1b12bd30e7d3136a8e566b50e07b52") (mkAccountNotes "I bet you think this account is about you") (AccountInfo Nothing Nothing False) False )
            ]
          )
        , ( AccountName "inflight"
          , Map.fromList
            [ ("3" , VanityAccount (PublicKey "c7fb88b67dee06b1f610411e48da6b87328fa4aea80c533a0ca96f64d3eb0632") (mkAccountNotes "") (AccountInfo Nothing Nothing False) True)
            ]
          )
        ])
      (Map.fromList
