...
frontend = (head', body)
  where
    head' = do
      ...
      elAttr "script" ("src" =: "http://code.jquery.com/ui/1.12.1/jquery-ui.js") blank
      elAttr "script" ("type" =: "text/javascript" <> "src" =: "http://cdnjs.cloudflare.com/ajax/libs/ace/1.2.5/ace.js" <> "charset" =: "utf-8") blank
